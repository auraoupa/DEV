...
ncks -O -F -d y,2,2 -d x,698,1329 /scratch/cnt0024/hmg2840/albert7a/NACHOS12.L75/NACHOS12.L75-I/NACHOS12.L75_mask2.nc new_mask_BDYS.nc

ncks -O -F -d y,1567,1567 -d x,500,1440 /scratch/cnt0024/hmg2840/albert7a/NACHOS12.L75/NACHOS12.L75-I/NACHOS12.L75_mask2.nc new_mask_BDYN.nc
